...
#### **5. Quy trình Kiểm soát Chất lượng - QC (Quality Control)**
...
### **PHẦN 2: CHƯƠNG TRÌNH ĐÀO TẠO NHÂN SỰ**

**Mục tiêu:** Xây dựng một đội ngũ nhân sự chuyên nghiệp, đồng bộ về năng lực và văn hóa, có khả năng thực thi hoàn hảo các SOPs và mang lại trải nghiệm dịch vụ xuất sắc.

---

#### **1. Đào tạo Hội nhập (Onboarding Program)**

*   **Đối tượng:** 100% nhân viên mới.
*   **Thời lượng:** 2 ngày (tập trung hoặc trực tuyến).
*   **Nội dung:**

| Module | Nội dung chi tiết | Mục tiêu |
| :--- | :--- | :--- |
...
#### **2. Đào tạo theo Vị trí Chức danh (Role-based Training)**

##### **a. Cố vấn Dịch vụ (Service Advisor)**

| Khóa học | Nội dung | Kỹ năng đầu ra |
| :--- | :--- | :--- |
| **Kỹ năng Giao tiếp & Dịch vụ Khách hàng** | - Kỹ năng lắng nghe chủ động. <br> - Ngôn ngữ cơ thể và giao tiếp phi ngôn ngữ. <br> - Kỹ năng đặt câu hỏi để khai thác thông tin. <br> - Xây dựng kịch bản giao tiếp cho từng điểm chạm trong SOPs. | Giao tiếp tự tin, chuyên nghiệp, tạo thiện cảm với khách hàng. |
| **Nắm vững Quy trình 12 Bước Kiểm tra xe** | - Đào tạo thực hành cách kiểm tra từng hạng mục. <br> - Cách giải thích ý nghĩa từng hạng mục cho khách hàng một cách dễ hiểu. <br> - Thực hành trên xe mẫu. | Thực hiện thành thạo quy trình kiểm tra, tư vấn chính xác. |
| **Kỹ năng Bán hàng & Tư vấn** | - Kỹ năng trình bày báo giá (nhấn mạnh lợi ích, sự cần thiết). <br> - Kỹ thuật bán hàng gia tăng (Up-sell) và bán chéo (Cross-sell) một cách tự nhiên. <br> - Kỹ thuật xử lý từ chối. | Gia tăng doanh thu trung bình/lượt xe, nâng cao hiệu quả tư vấn. |
| **Kỹ năng Xử lý Khiếu nại** | - Quy trình 5 bước xử lý khiếu nại (Lắng nghe - Đồng cảm - Xin lỗi - Giải quyết - Theo dõi). <br> - Đóng vai xử lý các tình huống khiếu nại thường gặp. | Biến khách hàng phàn nàn thành khách hàng trung thành. |

##### **b. Kỹ thuật viên (Technician)**

| Cấp độ | Nội dung đào tạo | Yêu cầu đầu ra |
| :--- | :--- | :--- |
| **Level 1 (Nền tảng)** | - An toàn lao động, PCCC, 5S tại xưởng. <br> - Sử dụng các công cụ, thiết bị cơ bản. <br> - Quy trình bảo dưỡng định kỳ các cấp (thay dầu, lọc, kiểm tra phanh...). <br> - Kỹ thuật cơ bản về lốp, ắc quy. | Thực hiện thành thạo các công việc bảo dưỡng định kỳ. |
| **Level 2 (Chuyên sâu)** | - Kỹ thuật chẩn đoán & sửa chữa các hệ thống phổ thông: Phanh ABS, hệ thống treo, hệ thống lái, điều hòa không khí. <br> - Sử dụng thành thạo máy chẩn đoán để đọc và phân tích lỗi. <br> - Sửa chữa các pan bệnh thông thường. | Chẩn đoán và sửa chữa thành công >80% các pan bệnh phổ biến. |
| **Level 3 (Chuyên gia)** | - Đào tạo chuyên sâu về các hệ thống phức tạp: sửa chữa hộp số tự động, đại tu động cơ, chẩn đoán hệ thống điện thân xe (Body electrics). <br> - Phân tích sơ đồ mạch điện. <br> - Cập nhật công nghệ trên các dòng xe mới. | Có khả năng xử lý các ca bệnh khó, trở thành chuyên gia tham vấn kỹ thuật. |

##### **c. Quản lý Garage (Garage Manager)**

| Khóa học | Nội dung | Kỹ năng đầu ra |
| :--- | :--- | :--- |
| **Kỹ năng Lãnh đạo & Quản lý Đội ngũ** | - Kỹ năng giao việc, ủy quyền và tạo động lực. <br> - Kỹ năng huấn luyện và phản hồi (coaching & feedback). <br> - Xây dựng văn hóa làm việc tích cực tại garage. | Dẫn dắt đội ngũ hoàn thành mục tiêu, giảm tỷ lệ nghỉ việc. |
| **Quản trị Vận hành & Tài chính** | - Đọc và phân tích Báo cáo Lãi/Lỗ (P&L) của garage. <br> - Quản lý chi phí, tối ưu hóa lợi nhuận. <br> - Quản lý tồn kho phụ tùng hiệu quả. | Ra quyết định kinh doanh dựa trên dữ liệu, đảm bảo sức khỏe tài chính của garage. |
| **Quản lý Hiệu suất (KPIs)** | - Hiểu rõ hệ thống KPIs của chuỗi (CSAT, NPS, FRR, Doanh thu...). <br> - Cách đặt mục tiêu, theo dõi và đánh giá hiệu suất của nhân viên. <br> - Lập kế hoạch hành động để cải thiện các chỉ số. | Thúc đẩy garage liên tục cải thiện và đạt các chỉ tiêu được giao. |
